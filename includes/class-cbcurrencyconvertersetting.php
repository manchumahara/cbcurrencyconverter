...
// If this file is called directly, abort.
    ...
    if (!class_exists('CBCurrencyconverterSetting')):
        ...
        class CBCurrencyconverterSetting {
             ...
             * @param array   $args settings field args
             */
            function callback_numberbutton( $args ) {

                $value = esc_attr( $this->get_option( $args['id'], $args['section'], $args['default'] ) );
                $size = isset( $args['size'] ) && !is_null( $args['size'] ) ? $args['size'] : 'regular';

                $html = sprintf( '<input type="number" style="height: 30px;" class="%1$s-text" id="%2$s[%3$s]" name="%2$s[%3$s]" value="%4$s" step="0.01"/>', $size, $args['section'], $args['id'], $value );
                ...
                <script>
                    jQuery(document).ready(function($) {
                        ...
                        if (typeof(localStorage) != 'undefined' ) {
                            activetab = localStorage.getItem("cbcurrencyconverter");
                        }
                        ...
                        if(window.location.hash){
                            ...
                            if (typeof(localStorage) != 'undefined' ) {
                                localStorage.setItem("cbcurrencyconverter", activetab);
                            }
                        }
                        ...
                        $('.nav-tab-wrapper a').click(function(evt) {
                            ...
                            if (typeof(localStorage) != 'undefined' ) {
                                localStorage.setItem("cbcurrencyconverter", $(this).attr('href'));
                            }
                            $('.group').hide();
